...
global.channelLink = "https://whatsapp.com/channel/0029Vb69AwzBadmYsRHxJR1H/100";
global.ytch = "NIMESHKA MIHIRAN";
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === 'add') {
            ...
            const channelId = welcomeData?.channelId || '1203631615136598@newsletter';
        ...
        if (action === 'remove') {
            ...
            const channelId = goodbyeData?.channelId || '120363161513998@newsletter';
